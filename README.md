...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rkrc7k8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rkrc7k8.containers.anotherwebservice.com/
...
```
git clone git@github.com:kuojo/container-rkrc7k8.git
cd container-rkrc7k8
```
...
```
docker attach container-rkrc7k8
```
